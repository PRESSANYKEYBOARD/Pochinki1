		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="./main_image/main1.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="./main_image/main2.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="./main_image/main3.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
			</div>
	        ...
	        <div class="row">
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card1.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card2.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card3.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card4.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card5.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card6.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card7.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card8.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="./fun_image/fun_card9.png" class="card-img-top" alt="...">
	                	<div class="card-body">
