...
<a href="/Hangeulum/funding/fun_write_Form">글쓰기로가기</a>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="/Hangeulumimage/funmain_image/main1.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="/Hangeulumimage/funmain_image/main2.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="/Hangeulumimage/funmain_image/main3.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
			</div>
	        ...
	        <div class="row">
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card1.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	               		...
	               		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">546,574,800원</li>
					  	</ul>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card2.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card3.png">
	                	<div class="card-body">
	            		...
	            		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">965,000원</li>
					  	</ul>
						<div class="card-footer">
					    	39일 남음
					  	</div>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card4.png">
	                	<div class="card-body">
	            		...
	            		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">158,000원</li>
					  	</ul>
						<div class="card-footer">
					    	5일 남음
					  	</div>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card5.png">
	                	<div class="card-body">
	            		...
	            		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">328,000원</li>
					  	</ul>
						<div class="card-footer">
					    	10일 남음
					  	</div>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card6.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card7.png">
	                	<div class="card-body">
	            		...
	            		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">323,580원</li>
					  	</ul>
						<div class="card-footer">
					    	32일 남음
					  	</div>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card8.png">
	                	<div class="card-body">
	               		...
	               		<ul class="list-group list-group-flush">
					    	...
					    	<li class="list-group-item">368,000,000원</li>
					  	</ul>
						<div class="card-footer">
					    	3일 남음
					  	</div>
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="/Hangeulumimage/fun_image/fun_card9.png" class="card-img-top" alt="...">
	                	<div class="card-body">
		        ...
		        <div class="footer_info_inner">
		            ...
		            <div class="footer_info_right">
		                <ul class="footer_info_list">
		                    ...
		                    <div class="footer_info_copyright"><a href="https://www.naver.com/" class="footer_info_naver"><img src="/Hangeulumimage_funmain_image/logo1.png" width="70" height="45" alt="한걸음"></a> Copyright &copy; StepWithUs Corp. All Rights Reserved.</div>
		                </ul>
		            </div>
		        </div>
		    </div>
