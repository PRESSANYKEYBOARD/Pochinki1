...
<html>
<head>
<link rel="stylesheet" href="resources/css/fun_main.css">
...
<div>
    <div id="header">
        <div class="headerContent">
            ...
            <img src="resources/image/funmain_image/logo_main.png" alt="로고" width="250" height="60">
            <div class="menu">
                <ul>
                    <li><a href="">기부</a></li>
                    <li><a href="">펀딩</a></li>
            ...
            <div class="header-r">
                ...
                <a href="#" class="search_btn">
                    <img src="resources/image/funmain_image/enlargement.png" alt="enlargement.jpg">
                </a>
            </div>
        </div>
	</div> <!-- header1 끝 -->
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="resources/image/funmain_image/main1.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="resources/image/funmain_image/main2.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
				<div class="carousel-item">
					<img src="resources/image/funmain_image/main3.png"
						class="d-block w-100" width="1800" height="300" alt="...">
				</div>
			</div>
	        ...
	        <div class="row">
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card1.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card2.png" class="card-img-top" alt="...">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card3.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card4.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card5.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card6.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card7.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card8.png">
	                	<div class="card-body">
	             ...
	             <div class="col-md-4 col-sm-6">
	                <div class="card" style="width: 18rem;">
	             		<img src="resources/image/fun_image/fun_card9.png" class="card-img-top" alt="...">
	                	<div class="card-body">
