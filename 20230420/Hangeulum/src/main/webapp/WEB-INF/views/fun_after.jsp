...
<html>
<head>
<link rel="stylesheet" href="resources/css/fun_after.css">
...
<div>
    <div id="header">
        <div class="headerContent">
            ...
            <img src="resources/image/after_image/logo_main.png" alt="로고" width="250" height="60">
            <div class="menu">
                <ul>
                    <li><a href="">기부</a></li>
                    <li><a href="">펀딩</a></li>
            ...
            <div class="header-r">
                ...
                <a href="#" class="search_btn">
                    <img src="resources/image/after_image/enlargement.png" alt="enlargement.jpg">
                </a>
            </div> <!-- header-r -->
        </div> <!-- header1 컨테이너 -->
    </div>
	...
	<div class="header3">
		<div class="header3_img">
			<img src="resources/image/after_image/after01.jpg" width="538px" height="301px">
		</div> <!-- header3 이미지 끝 -->
		<div class="header3_summary">
			<strong class="dday">D-35</strong>
			<h3 class="title">간편하게 즐기는 집밥, 가정식 도시락 12종</h3>
			<div class="graph">
				<div class="rate">
					<strong class="per">201%</strong>
				</div> <!-- rate -->
				<div class="bar_main">
				...
				<div class="credit_much">
					<span class="much">2,014,000원</span>
				</div> <!-- credit_much -->
			</div> <!--graph 끝  -->
			
			<div class="company_main">
				<div class="company_img">
					<img src="resources/image/after_image/company01.png">
				</div> <!-- company_img -->
	...
	<div class="content">
		<div class="content_left">
			...
			<div class="content_left1">
				<div class="content_left1-1">
					<img src="resources/image/funmain_image/sample4.jpg" width="550px" height= "550px">
				</div>
				<div class="content_left1-2">
			...
			<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel"> <!-- 부트스트랩 이미지 슬라이드 -->
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img src="resources/image/funmain_image/sample_silde1.jpg" class="d-block w-100" alt="...">
			    </div>
			...
			<div class="content_left1">
				<div class="content_left1-1">
					<img src="resources/image/funmain_image/sample_list.jpg" width="600px" height="1884px">
				</div>
				<div class="content_left1-2">
					<h4>도시락 12종 구성</h4>
				</div>
			...
			<div class="content_left1">
				...
				<div class="contetn_left1-2"> 
					<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="resources/image/funmain_image/after1.png" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="resources/image/funmain_image/after2.png" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="resources/image/funmain_image/after3.png" class="d-block w-100" alt="...">
					    </div>
					  </div>
			...
			<div class="content_guide">
				...
				<div class="content_guide_inner2">
					<h5><strong><img src="resources/image/funmain_image/cal.png" alt="끼에엨">결제 및 발송 예정일</strong></h5>
					<ul>
			...
			<div class="content_sns">
				...
				<ul>
					<li><a href=""><img src="resources/image/funmain_image/contact.png" width="75" height="75"><span>문의하기</span></a></li>
					<li><a href=""><img src="resources/image/funmain_image/smart.png" width="75" height="75"><span>스토어</span></a></li>
					<li><a href=""><img src="resources/image/funmain_image/home.png" width="75" height="75"><span>홈페이지</span></a></li>
					<li><a href=""><img src="resources/image/funmain_image/ins.png" width="75" height="75"><span>인스타그램</span></a></li>
				</ul>
			</div> <!-- content_sns -->
			...
			<div class="content_reply">
				...
				<ul>
					<li>
						<div class="reply_thumbnail"><img src="resources/image/funmain_image/user.png"></div>
						<div class="reply_date">2023.04.15 16:24:30</div>
						<div class="reply_user">XX님 40,000원 참여</div>
					</li>
					<li>
						<div class="reply_thumbnail"><img src="resources/image/funmain_image/user.png"></div>
						<div class="reply_date">2023.04.15 16:24:30</div>
		...
		<div class="content_right">
			...
			<div class="reward_set">
				<h5>도시락 12종 세트</h5>
				<ul>
					<li><small>현재 32명 펀딩 참여</small></li>
					<li><strong>발송예상일 2023.07.04</strong></li>
				</ul>
			</div> <!-- reward_set -->
		</div> <!-- content_right -->
	</div> <!-- content 끝 -->
		...
		<div class="content_hidden" aria-hidden="true"> <!-- 스크롤 히든 클래스 -->
			<div class="content_hidden_middle">
				<div class="hidden_jpg">
					<img src="resources/image/after_image/hidden_fungo.jpg">
				</div> <!-- hidden_jpg -->
		        ...
		        <div class="footer_info_inner">
		            ...
		            <div class="footer_info_right">
		                <ul class="footer_info_list">
		                    ...
		                    <div class="footer_info_copyright"><a href="https://www.naver.com/" class="footer_info_naver"><img src="resources/image/after_image/logo1.png" width="70" height="45" alt="한걸음"></a> Copyright &copy; StepWithUs Corp. All Rights Reserved.</div>
		                </ul>
		            </div>
		        </div>
		    </div>
...
<script type="text/javascript" src="resources/js/count_price.js"></script> <!-- 수량 가격에 맞게.... -->
<script type="text/javascript" src="resources/js/list.js"></script> <!-- 리스트가 바뀐다. -->
<script type="text/javascript" src="resources/js/scroll.js"></script> <!-- 스크롤을 내리면? -->
<script type="text/javascript" src="resources/js/modal.js"></script> <!-- 참여하기 버튼을 누르면 모달창이 뜬다. -->
<script type="text/javascript" src="resources/js/checkbox.js"></script> <!-- 펀딩 참여하기 - checkbox -->
