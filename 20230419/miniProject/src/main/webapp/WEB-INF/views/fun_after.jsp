...
<div>
	<div class="header1">
		<div class="container">
			...
			<div class="header1_mid">
				<ul>
	                <li><a href="">기부</a></li>
	                <li><a href="/miniProject/fun_main">펀딩</a></li>
	                <li><a href="">고객센터</a></li>
	            </ul>
			</div> <!-- 메뉴 끝  -->
			<div class="header1_right">
		        ...
		        <a href="#" class="search_btn">
		        	<img src="./image/main_image/enlargement.png" alt="enlargement.png">
		        </a>
			</div> <!-- 로그인 검색 끝 -->
		</div> <!-- header1의 컨테이너 끝 -->
	</div> <!-- header1 끝 -->
	...
	<div class="header3">
		<div class="header3_img">
			<img src="./image/after_image/after01.jpg" width="538px" height="301px">
		</div> <!-- header3 이미지 끝 -->
					  ...
					  <!-- 모달 창 -->
						<div class="modal">
						  <div class="modal-content">
						    <!-- 모달 내용 -->
						    <iframe class="modal-content" src="./fun_go_modal.jsp"></iframe>
						  </div>
						  <button type="button" class="btn-close" aria-label="Close">닫기 버튼</button>
						</div> <!-- modal -->
	...
	<div class="content">
		<div class="content_left">
			...
			<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel"> <!-- 부트스트랩 이미지 슬라이드 -->
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img src="./image/main_image/sample_silde1.jpg" class="d-block w-100" alt="...">
			    </div>
			...
			<div class="content_left1">
				<div class="content_left1-1">
					<img src="./image/sample_list.jpg" width="600px" height="1884px">
				</div>
				<div class="content_left1-2">
					<h4>도시락 12종 구성</h4>
				</div>
			...
			<div class="content_left1">
				...
				<div class="contetn_left1-2"> 
					<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
					  <div class="carousel-inner">
					    <div class="carousel-item active">
					      <img src="./image/main_image/after1.png" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="./image/main_image/after2.png" class="d-block w-100" alt="...">
					    </div>
					    <div class="carousel-item">
					      <img src="./image/main_image/after3.png" class="d-block w-100" alt="...">
					    </div>
					  </div>
			...
			<div class="content_guide">
				...
				<div class="content_guide_inner2">
					<h5><strong><img src="./image/main_image/cal.png" alt="끼에엨">결제 및 발송 예정일</strong></h5>
					<ul>
			...
			<div class="content_sns">
				...
				<ul>
					<li><a href=""><img src="./image/main_image/contact.png" width="75" height="75"><span>문의하기</span></a></li>
					<li><a href=""><img src="./image/main_image/smart.png" width="75" height="75"><span>스토어</span></a></li>
					<li><a href=""><img src="./image/main_image/home.png" width="75" height="75"><span>홈페이지</span></a></li>
					<li><a href=""><img src="./image/main_image/ins.png" width="75" height="75"><span>인스타그램</span></a></li>
				</ul>
			</div> <!-- content_sns -->
			...
			<div class="content_reply">
				...
				<ul>
					<li>
						<div class="reply_thumbnail"><img src="./image/user.png"></div>
		            ...
		            <div class="footer_info_inner">
		                ...
		                <div class="footer_info_right">
		                    <ul class="footer_info_list">
		                        ...
		                        <div class="footer_info_copyright"><a href="https://www.naver.com/" class="footer_info_naver"><img src="./image/logo1.png" width="70" height="45" alt="한걸음"></a> Copyright &copy; OneStep Corp. All Rights Reserved.</div>
		                    </ul>
		                </div>
...
<script type="text/javascript">
const fundingGoButton = document.querySelector('.funding_go_button');
const modal = document.querySelector('.modal');
const btnClose = document.querySelector('.btn-close');

fundingGoButton.addEventListener('click', function() {
  // 모달창 보여주기
